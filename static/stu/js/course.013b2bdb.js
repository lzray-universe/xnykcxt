          ...
          , c = {
            ...
            methods: {
                ...
                async submitAll(){
                    ...
                    if(answer.length!==questions.length) alert("题目数量不对");
                        ...
                        for(let i=0;i<questions.length;i++){
                            ...
                            let url = '/api/exam/api/student/course/entity/'+courseId+'/question/'+questions[i];
                            let data = {
                                courseId: courseId,
                        ...
                        let url = "/api/exam/api/student/course/entity/"+courseId+"/question";
                ...
                getAnswers(){
                    ...
                    fetch("/api/exam/api/student/course/entity/"+courseId+"/submit",options);
                    fetch("/api/exam/api/student/course/entity/"+courseId+"/question")
                      .then(response => {
                      ...
                      .then(data => {
                          ...
                          for(let i of data.extra){
                            ...
                            let url="/api/exam/api/student/course/entity/"+courseId+"/question/"+i.questionId;
                          ...
                          for(let i of questions){
                              let url="/api/exam/api/student/course/entity/"+courseId+"/question/"+i;
                ...
                getChoiceStatus(){
                    let questions=localStorage.getItem("questions").split(",");
                    fetch("/api/exam/api/student/course/entity/"+localStorage.getItem("courseId")+"/question")
                        .then(response => {
                ...
                getErrorContentList(e) {
                    if(sessionStorage.getItem("course_userInfo") == null){
                        ...
                        xhr.open('GET', '/api/exam/api/user/info', false); // false表示同步请求
                        xhr.send();
                        if (xhr.status === 200) {
            ...
            methods: {
                ...
                async submitAll(){
                    ...
                    if(answer.length!==questions.length) alert("题目数量不对");
                        ...
                        for(let i=0;i<questions.length;i++){
                            if(answer[i]=="1" || newQuestion[questions[i]]==answer[i].toUpperCase().split('').join(',')) continue;
                            let url = '/api/exam/api/student/paper/entity/'+paperId+'/question/'+questions[i];
                            let data = {
                                paperId: paperId,
                                questionId: questions[i],
                                studentAnswer: answer[i].toUpperCase().split('').join(','),
                        ...
                        await Promise.all(promises);
                        let url = "/api/exam/api/student/paper/entity/" + paperId + "/question";
                                    let xhr = new XMLHttpRequest();
                                    xhr.open('GET', url, false);
                                    xhr.send(null);
                                    if (xhr.status === 200) {
                ...
                getChoiceStatus(){
                    let questions=localStorage.getItem("questions").split(",");
                    fetch("/api/exam/api/student/paper/entity/"+localStorage.getItem("paperId")+"/question")
                        .then(response => {
                            return response.json(); // 解析JSON数据并返回另一个Promise
                        })
                        .then(data => {
